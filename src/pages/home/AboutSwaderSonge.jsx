...
const AboutSwaderSonge = () => {
    return (
        <div className="w-10/12 mx-auto my-20 relative">
            ...
            <div className="h-[400px] md:h-[500px] w-full bg-black absolute z-20 inset-0 opacity-50"></div>
            <div className="w-10/12 mx-auto flex flex-col justify-center items-center absolute bg-white h-[300px] md:h-[350px] inset-0 py-20 top-14 md:top-20 z-50">
